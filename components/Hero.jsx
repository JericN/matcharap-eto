// Landing hero: arched "Matcharap Eto" logo over the whisking mascot, with stamp + corners.
export default function Hero() {
  return (
    <header className="hero">
      <span className="corner tl">est. 2026</span>
      <span className="corner bl">metro manila</span>
      <span className="corner br">by BriarBear</span>
      <svg className="stamp-corner" viewBox="0 0 100 100" fill="none" aria-hidden="true">
      ...
      <div className="arch-wrap">
        <svg viewBox="0 44 520 300" role="img" aria-label="Matcharap Eto logo with whisking mascot">
          ...
          <g transform="translate(63,2)" stroke="#3f5031" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" fill="none">
            ...
            <g><path d="M96 290 h54 l-6 30 a8 8 0 0 1 -8 7 h-26 a8 8 0 0 1 -8 -7 Z" fill="#eef0e2"/>
              <path d="M104 298 h38 l-3 16 h-32 Z" fill="#7faa4e" stroke="none"/>
              <path d="M118 282 q6 -8 0 -16 q-6 -8 0 -16" strokeWidth="2.4"/>
              <path d="M132 282 q6 -8 0 -16 q-6 -8 0 -16" strokeWidth="2.4"/></g>
      ...
      <p className="tagline">whisked fresh in metro manila</p>
      <p className="sub">events · cost calculator · powder guide</p>
    </header>
  );
}
